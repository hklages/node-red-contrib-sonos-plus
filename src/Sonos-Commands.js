...
module.exports = {
  ...
  */
   ...
   *
   * @return {Promise<DidlBrowseItem[]>} all My-Sonos Items and SONOS-Playlists as array, could be empty
   *
   ...
   * @param {string} playerUrlOrigin valid SONOS player URL.origin http://192.168.178.35:1400
   *
   * @return {Promise<DidlBrowseItem[]>} all SONOS-Playlists as array, could be empty
   *
   * @throws {error} nrcsp: invalid return from Browse, didlXmlToArray error
   */
   ...
   * @param {string} playerUrlOrigin valid SONOS player URL.origin http://192.168.178.35:1400
   *
   * @return {Promise<DidlBrowseItem[]>} all SONOS-queue items, could be empty
   *
   * @throws {error} nrcsp: invalid return from Browse, didlXmlToArray error
   */
   ...
   * 
   * @return {Promise<(object|boolean)>} true or outArgs of that action
   *  
  ...
  */
   ...
   *
   * @return {Promise<DidlBrowseItem[]>} Promise, array of {@link Sonos-Commands#DidlBrowseItem}, maybe empty array.
   *                   
   ...
   * 
   * @return {string} service name such as "Amazon Music" or empty string
   *
   ...
   * 
   * @return {string} TuneIn radio id or if not found empty
   *
   ...
   * 
   * @return {string} Upnp class such as "object.container.album.musicAlbum"
   *
