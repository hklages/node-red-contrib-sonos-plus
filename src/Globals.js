...
module.exports = {
  ...
  REGEX_TIME_SPECIAL: /^(([0-1][0-9]):([0-5][0-9]):([0-5][0-9]))$/, // hh:mm:ss but hours 0 to 19
  // credit to: https://regexpattern.com/24-hour-time/
  REGEX_TIME_24: /^(?:[01]\d|2[0-3]):[0-5]\d:[0-5]\d$/,
